...
module restore_engine #(
    ...
    // High while the identity reader owns the bus, so the top can release the
    // idle precharge exactly as it does for an ordinary GB ROM dump.
    output wire rom_reading,
