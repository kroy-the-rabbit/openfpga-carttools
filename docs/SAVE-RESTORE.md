...
and on **Shadowgate Classic**, MBC5 8 KiB (type `1B`, 1 MiB ROM), using a save
made in mGBA from the cartridge's own ROM dump.

MBC1 8 KiB and other MBC3 and MBC5 cartridges (MBC5 ROM up to 4 MiB)
