...
CartTools reads Game Gear ROMs through the official Analogue Game Gear adapter
with standard Sega banking. On build 563E, World Series Baseball (USA),
Arch Rivals (USA) and Sonic the Hedgehog 2 (World) each matched the MAME
reference size, SHA-1 and CRC32.
