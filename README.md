...
| Save restore | **alpha; verified on Pokemon Silver**, MBC3 32 KiB, **and Dragon Warrior III**, MBC5 32 KiB. MBC1 8 KiB, other MBC3 32 KiB and MBC5 8 or 32 KiB cartridges are implemented but untested. See [save restore](docs/SAVE-RESTORE.md) |
